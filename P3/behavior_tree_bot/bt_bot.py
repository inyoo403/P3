...
def setup_behavior_tree():
    ...
    # 2. Aggressive multi-attack when having overwhelming advantage
    ...
    # 3. Opportunistic attack (when enemy fleets are empty)
    ...
    # 4. Defensive reinforcement when defense is needed
    ...
    # 6. Mid-late game strategy (advantage situation)
    ...
    # 6b. Aggressive attack when enemy is nearby
    ...
    # 7. Basic expansion strategy (when neutral planets exist)
    ...
    # Assemble complete BT structure
    root.child_nodes = [
